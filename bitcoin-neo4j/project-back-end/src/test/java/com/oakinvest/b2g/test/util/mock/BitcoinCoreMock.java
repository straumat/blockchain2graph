package com.oakinvest.b2g.test.util.mock;
...
import com.oakinvest.b2g.dto.bitcoin.core.util.BitcoinCoreResponseError;
...
public class BitcoinCoreMock {
     ...
     */
    @Around("execution(* com.oakinvest.b2g.service.BitcoinCoreService.getBlockCount())")
     ...
     * @throws Throwable exception.
     */
    @Around("execution(* com.oakinvest.b2g.service.BitcoinCoreService.getBlockHash(..)) && args(blockHeight)")
     ...
     * @throws Throwable exception.
     */
    @Around("execution(* com.oakinvest.b2g.service.BitcoinCoreService.getBlock(..)) && args(blockHash)")
     ...
     * @throws Throwable exception.
     */
    @Around("execution(* com.oakinvest.b2g.service.BitcoinCoreService.getRawTransaction(..)) && args(transactionHash)")
