...
public class BitcoindServiceTest extends BaseTest {
    ...
    public final void getBlockCountTest() {
        assertThat(getBitcoindService().getBlockCount().getError())
                .as("Check that the api does not return an error")
                .isNull();

        assertThat(getBitcoindService().getBlockCount().getResult())
    ...
    public final void getBlockCountTestInError() {
        for (int i = 0; i < NUMBER_OF_BLOCKS + 1; i++) {
            if (getBitcoindService().getBlockCount().getError() != null) {
                return;
            }
        }
    ...
    public final void getBlockHashTest() {
        assertThat(getBitcoindService().getBlockHash(BLOCK_NUMBER_VALID).getError())
                .as("Check that the api does not return an error")
                .isNull();

        assertThat(getBitcoindService().getBlockHash(BLOCK_NUMBER_VALID).getResult())
    ...
    public final void getBlockHashTestInError() {
        assertThat(getBitcoindService().getBlockHash(BLOCK_IN_ERROR_1).getError())
        ...
        for (int i = 0; i < NUMBER_OF_ERRORS; i++) {
            getBitcoindService().getBlockHash(BLOCK_IN_ERROR_1);
        }
    ...
    public final void getBlockTest() {
        ...
        // Test.
        GetBlockResult blockResult = getBitcoindService().getBlock(BLOCK_HASH).getResult();
    ...
    public final void getBlockTestInError() {
        assertThat(getBitcoindService().getBlock(BLOCK_HASH_IN_ERROR_1).getError())
                .as("Check that the api does return an error")
                .isNotNull();

        for (int i = 0; i < NUMBER_OF_ERRORS + 1; i++) {
            getBitcoindService().getBlock(BLOCK_HASH_IN_ERROR_1);
        }
    ...
    public final void getRawTransactionTest() {
        ...
        // Test.
        // Transaction.
        GetRawTransactionResult transactionResult = getBitcoindService().getRawTransaction(BLOCK_EXISTING_TRANSACTION_HASH).getResult();
        ...
        GetRawTransactionResult coinbaseTransaction = getBitcoindService().getRawTransaction(COINBASE_TRANSACTION_HASH).getResult();
    ...
    public final void getRawTransactionInError() {
        assertThat(getBitcoindService().getRawTransaction(TRANSACTION_HASH_IN_ERROR_1).getError())
                .as("Check that the api does return an error")
                .isNotNull();

        // After NUMBER_OF_ERRORS errors, the service should return to normal.
        for (int i = 0; i < NUMBER_OF_ERRORS; i++) {
            getBitcoindService().getRawTransaction(TRANSACTION_HASH_IN_ERROR_1);
        }
    ...
    public final void getRawTransactionWithEmptyAddressesTest() {
        ...
        assertThat(getBitcoindService().getRawTransaction(invalidTransaction).getResult().getVout().get(1).getScriptPubKey().getAddresses())
                .as("Empty address")
                .isEmpty();
    }
    ...
    public final void errorManagementTest() {
        ...
        // Test.
        assertThat(getBitcoindService().getBlockHash(nonExistingBlockNumber).getError())
                .as("Error")
                .isNotNull()
