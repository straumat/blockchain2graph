package com.oakinvest.b2g.bitcoin.dto.bitcoin.core.util;
...
public class BitcoinCoreResponseError implements Serializable {
	...
	public final String toString() {
		return "BitcoinCoreResponseError{" + "code=" + code + ", message='" + message + '\'' + '}';
	}
